...
if EstimOpt.Display ~= 0
    cprintf('Estimation method: '); cprintf('*Black', 'maximum likelihood \n')
...
if EstimOpt.NVarS > 0
    ...
    Results.R_out(EstimOpt.NVarA + 6:EstimOpt.NVarA+EstimOpt.NVarS+5,1:2) = [EstimOpt.NamesS, num2cell(Results.bhat(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end))];
    Results.R_out(EstimOpt.NVarA + 6:EstimOpt.NVarA+EstimOpt.NVarS+5,4:5) = num2cell([Results.std(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end), pv(Results.bhat(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end),Results.std(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end))]);
    for i=1:EstimOpt.NVarS
        Results.R_out(EstimOpt.NVarA + 5+ i,3) = make_stars(pv(Results.bhat(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end),Results.std(EstimOpt.NVarA*(1+NVarMOld)+EstimOpt.NVarNLT+1:end)),1,i);
    end
end
