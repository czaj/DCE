function [LL,g,h] = LL_hmnl_MATlike(Y,Xa,Xm,X_str,X_mea,Xmea_exp,err_sliced,W,EstimOpt,OptimOpt,b0)

LLfun = @(B) LL_hmnl(Y,Xa,Xm,X_str,X_mea, Xmea_exp,err_sliced,EstimOpt,B);
