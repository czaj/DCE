...
% [Results.bhat,LL,Results.exitflag,Results.output,Results.lambda,Results.g,Results.hess] = ...
%            knitro_nlp(LLfun,b0,[],[],[],[],[],[],[],[],EstimOpt.OptimOpt_KNitro);
...
% [Results.bhat,LL,Results.exitflag,Results.output,Results.lambda,Results.g,Results.hess] = ...
%            knitro_nlp(LLfun,b0,[],[],EstimOpt.CONS1,EstimOpt.CONS2,[],[],[],[],EstimOpt.OptimOpt_KNitro);      
...
[Results.bhat,LL,Results.exitflag,Results.output,Results.lambda,Results.g,Results.hess] = ...
           knitro_nlp(LLfun,b0,[],[],[],[],lb,ub,[],[],EstimOpt.OptimOpt_KNitro); 

% LLfun(Results.bhat)
%        
% [Results.bhat,LL,Results.exitf,Results.output,Results.g,Results.hess] = fminunc(LLfun,Results.bhat,OptimOpt)
